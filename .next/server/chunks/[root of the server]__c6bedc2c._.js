...
async function POST(req) {
    ...
    try {
        const response = await fetch("https://api-inference.huggingface.co/models/LGAI-EXAONE/EXAONE-Deep-2.4B", {
            method: "POST",
            headers: {
        ...
        console.log("Hugging Face API Raw Response:", text);
        // ✅ HTML 오류 페이지 방지
        if (!response.ok) {
        ...
        try {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                response: result[0]?.generated_text || "No response"
            });
        } catch (jsonError) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__c6bedc2c._.js.map